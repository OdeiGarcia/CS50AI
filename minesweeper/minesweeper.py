            ...
            for sentence in self.knowledge:
                for sentence2 in self.knowledge:
                    ...
                    if sentence.cells.issubset(sentence2.cells):
                        new_sentence = sentence2.cells -sentence.cells
                        new_sent_count = sentence2.count - sentence.count
                        new_sent = Sentence(new_sentence, new_sent_count)
